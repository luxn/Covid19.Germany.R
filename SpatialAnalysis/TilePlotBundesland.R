...
plot.bundesland <- ggplot(data=bundesland.df, aes(Kalenderwoche, Bundesland)) +
  geom_tile(aes(fill=Inzidenz), colour="white") +
  scale_y_discrete(limits = rev(levels(bundesland.df$Bundesland))) +
  ...
  ggtitle("Verlauf der 7-Tage Inzidenz pro 100.000 Einwohner auf Bundeslandebene")


ggsave("./Images/inzidenzverlauf.bundesland.png", plot.bundesland, dpi="retina", width=9, height=3)
